	  ...
	  function Container(props) {
	    ...
	    _this.updateOffset = function (_ref) {
	      ...
	      _this.channel.update(function (data) {
	        ...
	        !data.scrollableTarget && _this.handleNodeRef(data.node);
	      });
	    };
	    ...
	    _this.handleNodeRef = function (node) {
	      ...
	      _this.channel.update(function (data) {
	        ...
	        var parentScrollableTarget = parentChannel && parentChannel.getCurrentData().scrollableTarget;

	        var defaultNode = parentScrollableTarget || window;
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.updateContext = function (_ref) {
	    ...
	    if (!scrollableTarget) {
	      ...
	      _this5.scrollableTarget && _this5.off(TARGET_EVENTS, _this5.handleRecomputateEvents);
